package com.hally.influencerai.chat.data;

import android.content.Context;
import android.content.SharedPreferences;

import com.hally.influencerai.chat.model.User;
...
public class SharedPreferenceHelper {
    ...
    private static String SHARE_KEY_AVATA = "photoUrl";
    private static String SHARE_KEY_UID = "id";
