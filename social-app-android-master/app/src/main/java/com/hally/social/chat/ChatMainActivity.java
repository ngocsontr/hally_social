...
import com.hally.social.chat.ui.FriendsFragment;
import com.hally.social.chat.ui.GroupFragment;
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Log.d(TAG, " StaticConfig.UID : " + StaticConfig.UID);
                } else {
...
//        adapter.addFrag(new GroupFragment(), STR_INFO_FRAGMENT);
